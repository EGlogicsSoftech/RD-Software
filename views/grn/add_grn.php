 ...
 -->
                                ...
                                <div class="box-body ab-class">
                                    ...
                                    <form action="<?=base_url('grn/saveGrn');?>" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>Supplier PO No. <span style="color:red;">*</span></label>
                                            <select class="form-control" name="supplier_pon" id="supplier_pon">
                                                ...
                                                <?php if( $_POST['supplier_id'] ){ 
                                                		...
                                                		$rows = $this->db->get_where('supplier_po',array('sup_id'=> $_POST['supplier_id']))->result_array();
                                                		
                                                		foreach( $rows as $row )
                                                			{ ?>
                                                				<option <?php if( $this->input->post('supplier_pon') == $row['sup_po_id'] ) { echo "selected"; } ?> value="<?php echo $row['sup_po_id']; ?>"><?php echo $row['po_num']; ?></option>';
                                                			<?php } 
                                                } ?>
                                            </select>
