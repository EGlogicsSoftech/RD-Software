                        ...
                        <div class="col-md-9">
                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                    ...
                                    <form action="<?=base_url('stock/UpdateStockIssuance/'.$issue->id);?>" method="post">
                                        <?php if( $msg ) { ?>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>Ref no/ Invoice No</label>
                                             <input type="text" class="form-control" name="ref_no" value="<?php echo $issue->ref_id; ?>" placeholder="Put Reference no" />
										...
										<div class="form-group col-md-6">
                                            ...
                                            <div class='input-group date' id='startDate'>
                                                ...
                                                <input type='text' class="form-control" name="issued_date" value="<?php echo $issue->Issued_date; ?>" />
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>Issued By</label>
                                             <input type="text" class="form-control" name="issue_by" value="<?php echo $issue->issued_by; ?>" placeholder="Issued By Whom" />
                                            <?php echo form_error('issue_by'); ?>
                                        </div>
                                        
                                        <div class="form-group col-md-6">
                                            <label>Issued To</label>
                                             <input type="text" class="form-control" name="issue_to" value="<?php echo $issue->issued_to; ?>" placeholder="issued to whom" />
