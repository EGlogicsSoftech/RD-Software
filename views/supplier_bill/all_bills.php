                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr <?php if( $bill['status'] == 2) : ?> style="background: #FDEDEC;" <?php endif; ?>>
                                                    <td><?=$i;?></td>
                                                    <td><?=GetSupplierData( $bill['sup_id'] )->supplier_code;?></td>
                                                    <td><?=GetSupplierData( $bill['sup_id'] )->supplier_name;?></td>
                                                    <td><?=$bill['challan_num'];?></td>
                                                    <td><?=$bill['num_of_box'];?></td>
                                                    <td><?php if( $bill['status'] == 2) : ?><span style="color:#ff6666;">Not Approved</span> <?php else : ?> <span style="color:green;">Approved</span> <?php endif; ?></td>
                                                    <td>
                                                    <?php if( is_UserAllowed('add_grn_item')){ ?>
                                                    	<a href="<?=base_url('supplier_bill/view').'/'.$bill['id'];?>">View</a><!-- <a href="<?=base_url('grn/edit').'/'.$grn['id'];?>">Update</a> --> 
                                                    <?php } ?>    
                                                    </td>
                                                </tr>
                                            <?php $i++; endforeach; ?>  
