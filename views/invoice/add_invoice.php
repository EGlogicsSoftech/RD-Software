                        ...
                        <div class="col-md-9">
                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                    ...
                                    <form action="<?=base_url('invoice/SaveInvoice');?>" method="post">
                                        <?php if( $msg ) { ?>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control invoice_custpo" name="invoice_custpo" style="width:100%;">
                                                <option value="">Select Customer</option>
                                                <?php foreach( $customers as $customer ) :  ?>
                                                    <option value="<?=$customer['customer_id'];?>"><?=$customer['name'];?></option>
                                                <?php endforeach; ?>
                                            </select>
                                            <?php echo form_error('invoice_custpo'); ?>
                                        </div>

                                       <div class="form-group col-md-6">
                                            <label>Invocie No</label>
                                            <select class="form-control" name="invoice_no" style="width:100%;">
                                                <option value="">Select Invoice</option>
                                                <?php foreach( $packings as $packing ) :  ?>
                                                    <option value="<?=$packing['packing_id'];?>"><?=$packing['packing_num'];?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <!-- <div class='input-group date' id='datetimepicker1'>
                                                <input type="text" class="form-control" placeholder="Enter Date" value="<?php echo $this->input->post('date')?>" name="date" data-date-format="mm/dd/yy" id="datepicker" >
