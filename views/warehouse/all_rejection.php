                                    ...
                                    <table id="example1" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Date</th>
                                                <?php if( is_UserAllowed('update_wr')){ ?>
                                                	<th>Action</th>
                                                <?php } ?>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <?php $i = 1; foreach( $rejects as $reject ) : ?>
                                                <tr>
                                                    <td><?=$i;?></td>
                                                    <td><?=GetLoggedinUserName( $reject['user_id'] );?></td>
                                                    <td><?=$reject['invoice_no'];?></td>
                                                    <td><?=GetSupplierData( $reject['sup_id'] )->supplier_name;?></td>
                                                    <td><?=SPOData( $reject['spo_id'] )->po_num;?></td>
                                                    <td><?=GetItemData( $reject['item_id'] )->ITEM_CODE;?></td>
                                                    <td><?=$reject['qty'];?></td>
                                                    <td><?php echo date("d-m-Y", strtotime( $reject['created_at'] ) );?></td>
                                                    
                                                    <?php if( is_UserAllowed('update_wr')){ ?>
                                                    	<td><a href="<?=base_url('/warehouse/edit_rejection').'/'.$reject['id'];?>">Update</a></td>
                                                	<?php } ?>
                                                </tr>
                                            <?php $i++; endforeach; ?>    
