                        ...
                        <div class="col-md-9">
                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                    ...
                                    <form action="<?=base_url('warehouse/save_rejection');?>" method="post">
                                        <?php if( $msg ) { ?>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select class="form-control" name="invoice_no" style="width:100%;">
                                                ...
                                                <?php foreach( $invoices as $invoice ) :  ?>
                                                    <option value="<?=$invoice['ref_id'];?>"><?=$invoice['ref_id'];?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" name="rejected_qty" value="<?php echo $this->input->post('rejected_qty')?>" placeholder="Rejected Quantity" />
                                            <?php echo form_error('rejected_qty'); ?>
                                        </div>

                                        <div class="form-group col-md-3">
                                           <!--  <input type="text" class="form-control" name="date" value="<?php //echo $this->input->post('date')?>" placeholder="Date" /> -->
