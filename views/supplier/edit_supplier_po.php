                        ...
                        <div class="col-md-9">
                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body"> 
                                    ...
                                    <form action="<?=base_url('supplier/UpdateSupplierPO12');?>" method="post">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" name="supplier_name" id="supplier_name">
                                                ...
                                                <?php foreach( $suppliers as $supplier ) : ?>
                                                    <option <?php if( $supplier_po->id == $supplier['id'] ) { echo "selected"; } ?> value="<?=$supplier['id'];?>"><?=$supplier['supplier_name'].' - ('.$supplier['supplier_code'].')';?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="po" value="<?php echo $supplier_po->po_num; ?>"  placeholder="Enter PO"/>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class='input-group date' id='startDate'>
                                                ...
                                                <input type='text' class="form-control" name="date" value="<?php echo $supplier_po->delivery_date; ?>" />
