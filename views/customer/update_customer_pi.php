                        ...
                        <div class="col-md-9">
                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                    ...
                                    <form action="<?=base_url('customer/UpdateCustomerPI/'.$customer_pi->cust_pi_id);?>" method="post">
                                        <?php if( $msg ) { ?>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" name="customer_name">
                                                ...
                                                <?php foreach( $customers as $cust ) : ?>
                                                    <option <?php if( $cust['customer_id'] == $customer_pi->cust_id ){ echo "selected"; } ?> value="<?=$cust['customer_id'];?>"><?=$cust['name'].' - ('.$cust['code'].')';?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>PI#</label>
                                            <input type="text" class="form-control" name="pi" value="<?php echo $customer_pi->pi_num; ?>" placeholder="Enter PI"/>
