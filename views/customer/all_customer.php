                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $i = 1; foreach( array_reverse( $customers ) as $customer ) : ?>
                                                <tr>
                                                    <td><?=$i;?></td>
                                                    ...
                                                    <td><?=$customer['description'];?></td>
                                                   	<td>
                                                    <?php if( is_UserAllowed('view_customer')){ ?>
                                                   		<a href="<?=base_url('customer/view').'/'.$customer['id'];?>">View</a>
                                                   	<?php } ?>	
                                                   		<?php if( is_UserAllowed('update_customer')){ ?>
                                                   			<a href="<?=base_url('customer/manage_customer').'/'.$customer['id'];?>">Update</a>
                                                   		<?php } ?>	
                                                   	</td>
                                                </tr>
                                            <?php $i++; endforeach; ?>    
