                        ...
                        <div class="col-md-4">
                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                    ...
                                    <form action="<?=base_url('user/Update_designation').'/'.$designationdata->id;?>" method="post">
                                        <?php if( $msg ) { ?>
                                        ...
                                        <div class="form-group col-lg-12">
                                            ...
                                            <input type="text" class="form-control" name="name" value="<?php echo $designationdata->designation_name; ?>" placeholder="Enter Designation"/>
                                            <?php echo form_error('name'); ?>
                                        </div>

                                        <div class="form-group col-lg-12">
                                            <label>Description <span style="color:red;">*</span></label>
                                            <input type="text" class="form-control" name="description" value="<?php echo $designationdata->designation_description; ?>"  placeholder="Enter Description"/>
