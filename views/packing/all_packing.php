                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $i = 1; foreach( $packings as $packing ) : ?>
                                                <tr <?php if( $packing['status'] == 2) : ?> style="background: #FDEDEC;" <?php endif; ?>>
                                                    <td><?=$i;?></td>
													...
													<?php endif; ?>
													<td><?=$packing['packing_num'];?></td>
                                                    <td><?php echo date("d-m-Y", strtotime( $packing['date'] ) );?></td>
                                                    <td><?php if( $packing['status'] == 2) : ?><span style="color:#ff6666;">Not Approved</span> <?php else : ?> <span style="color:green;">Approved</span> <?php endif; ?></td>
                                                    <td>
                                                    <?php if( is_UserAllowed('add_pl_item')){ ?>
                                                    	<a href="<?=base_url('packing/view/'.$packing['id']);?>">View</a>
                                                    <?php } ?>    
                                                    </td>
                                                </tr>
                                            <?php $i++; endforeach; ?>    
