...
header("Content-Disposition: attachment; filename=PL/".$packing_list->packing_id.".xls");
...
<table class="table table-striped" style="border-collapse: collapse; width:100%">
	<thead>
		<tr> 
			...
			<th style="border:1px solid #000;">Qty/Box</th>
			<th style="border:1px solid #000;">Total Qty</th>
			<th style="border:1px solid #000;">Net Weight</th>
			<th style="border:1px solid #000;">Gross Weight</th>
	...
	<tbody>    
		...
		<tr>
			...
			<td style="border:1px solid #000; text-align:center;"><?php echo $item['qty_per_box'].' '.GetItemUnit( GetItemData( $item['item_id'] )->ITEM_UNIT ); ?></td>
			...
			<td style="border:1px solid #000; text-align:center;"><?php echo $item['gross_weight']; ?></td>
			<td style="border:1px solid #000; text-align:center;"><?php echo GetCustomerData( $item['customer_id'] )->name; ?></td>
			<td style="border:1px solid #000; text-align:center;"><?php echo CPIdata( $item['cust_pi'])->pi_num; ?></td>
