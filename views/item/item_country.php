                        ...
                        <div class="col-md-4">
                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                    ...
                                    <form action="<?=base_url('item/add_country');?>" method="post">
                                        <?php if( $msg ) { ?>
                                        ...
                                        <div class="form-group col-lg-12">
                                            ...
                                            <input type="text" class="form-control" name="country_name" value="<?php echo $this->input->post('country_name')?>"  placeholder="Country Name"/>
                                            <?php echo form_error('country_name'); ?>
                                        </div>
                                        
                                        <div class="form-group col-lg-12">
                                            <label>Country Code <span style="color:red;">*</span></label>
                                            <input type="text" class="form-control" name="country_code" value="<?php echo $this->input->post('country_code')?>"  placeholder="Country Code"/>
