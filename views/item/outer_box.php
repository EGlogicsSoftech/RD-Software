                        ...
                        <div class="col-md-4">
                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                    ...
                                    <form action="<?=base_url('item/add_outer_box');?>" method="post">
                                        <?php if( $msg ) { ?>
                                        ...
                                        <div class="form-group col-lg-12">
                                            ...
                                            <input type="text" class="form-control" name="ob_size" value="<?php echo $this->input->post('ob_size')?>"  placeholder="Outer Box Size"/>
                                            <?php echo form_error('ob_size'); ?>
                                        </div>
                                        
                                         <div class="form-group col-lg-12">
                                            <label>CBM <span style="color:red;">*</span></label>
                                            <input type="text" class="form-control" name="ob_cbm" value="<?php echo $this->input->post('ob_cbm')?>"  placeholder="cbm"/>
