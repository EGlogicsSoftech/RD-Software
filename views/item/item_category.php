                        ...
                        <div class="col-md-4">
                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                    ...
                                    <form action="<?=base_url('item/add_category');?>" method="post">
                                        <?php if( $msg ) { ?>
                                        ...
                                        <div class="form-group col-lg-12">
                                            ...
                                            <input type="text" class="form-control" name="cat_name" value="<?php echo $this->input->post('cat_name')?>"  placeholder="Category Name"/>
                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body table-responsive ab-filter">
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php $i=1; foreach($CatArray as $cat) { ?>
                                                <tr>
                                                    <td><?=$i;?></td>
                                                    <td><?=$cat['ID'];?></td>
                                                    <td><?=$cat['CATEGORY_NAME'];?></td>
                                                    <?php if( is_UserAllowed('update_category')){ ?>
                                                    	<td><a href="<?=base_url('item/updatecategory').'/'.$cat['ID'];?>">Update</a></td>
                                                	<?php } ?>
                                                </tr>
                                            <?php $i++; }?>
                                        </tbody>
